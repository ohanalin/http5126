...
-- B
SELECT * FROM  stock_items WHERE NOT category='Canine' AND NOT category='Feline' AND inventory>20;

-- 5
-- A
SELECT first_name,last_name,role,phone FROM  employees ORDER BY last_name;
-- B
SELECT id,item,price,inventory FROM stock_items ORDER BY price DESC;